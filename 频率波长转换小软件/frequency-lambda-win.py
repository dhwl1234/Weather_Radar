...
# 添加标题
title_label = tk.Label(frame, text="波长频率自动换算小软件", font=("微软雅黑", 30), pady=0)
...
conversion_dropdown.config(font=("Times New Roman", 14))
...
unit_dropdown.config(font=("Times New Roman", 14))
unit_dropdown.grid(row=1, column=3, padx=0, pady=10, sticky="w")

# 创建确定按钮
button = tk.Button(frame, text="确定", command=convert, font=("Times New Roman", 14))
button.grid(row=2, column=3, padx=0, pady=10, sticky="w")

# 光速输入框
c_label = tk.Label(frame, text="光速 (m/s):", font=("Times New Roman", 14))
