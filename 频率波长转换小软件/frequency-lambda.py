...
conversion_dropdown.grid(row=1, column=1, padx=0, pady=10)
...
unit_dropdown.grid(row=1, column=3, padx=0, pady=10)

# 创建确定按钮
button = tk.Button(frame, text="确定", command=convert)
button.grid(row=2, column=3, padx=10, pady=10)

# 光速输入框
c_label = tk.Label(frame, text="光速 (m/s):")
